...
\begin{deluxetable}{l c c c c c c}\tablenum{1}
...
\tablecolumns{7}
\tablehead{
	\colhead{Time} & \colhead{$R_{\star}$} & \colhead{$r_{\rm conv}$} & \colhead{$v_{\rm conv, max}$} & \colhead{$r_{\rm conv}/v_{\rm conv, max}$} & \colhead{{\bf Ro}} & \colhead{${\rm C_X}$ } \\
